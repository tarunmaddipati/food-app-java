...
import org.food.service.CustomerService;
import org.food.service.DishService;
...
public class OrdersMenu extends Menu {
            ...
            while (true) {
                ...
                switch (input) {
                    ...
                    case 4 -> {
                        ...
                        super.displayMenu();
                        return; // Exit the method to avoid looping
                    }
                    default -> System.out.println("Invalid Input. Please enter a valid option (1-4).");
                }
            }
        } catch (Exception e) {
    ...
    private void searchOrderForm() {
        try {
            Scanner scanner = new Scanner(System.in);
            System.out.println("Please enter the following details to search for an Order\n");
    ...
    private void newOrderForm() throws DishNotFoundException {
        ...
        try {
            ...
            while (addMoreItems.equalsIgnoreCase("Y")) {
                ...
                addMoreItems = scanner.nextLine().trim();
            }
